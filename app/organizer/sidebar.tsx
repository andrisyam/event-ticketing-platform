...
const navItems = [
  ...
  { href: '/organizer/attendees', label: 'Peserta', icon: Users },
  { href: '/organizer/check-in', label: 'Check-in', icon: QrCode },
  { href: '/organizer/analytics', label: 'Analitik', icon: BarChart3 },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
            <Link href="/" className="flex items-center gap-2">
              ...
              <div>
                <span className="text-lg font-bold text-sidebar-foreground">Organizer</span>
